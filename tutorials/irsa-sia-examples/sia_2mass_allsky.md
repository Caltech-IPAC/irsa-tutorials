...
**Note on SIA versions:** IRSA supports both SIA v1 and SIA v2 protocols. The version used depends on the specific dataset. The IRSA website linked above provides information on which version each service uses and how to access them. This tutorial uses SIA v1 for 2MASS All-Sky Atlas images.
