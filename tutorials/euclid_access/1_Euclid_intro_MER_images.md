...
# !pip install numpy astropy matplotlib astroquery>=0.4.10 sep>=1.4 fsspec
```
...
This notebook will search specifically in the euclid_DpdMerBksMosaic collection which is the MER images and catalogs.
This query will return any images in this collection with pixels that overlap the search region.
