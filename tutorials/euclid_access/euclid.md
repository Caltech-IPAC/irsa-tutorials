...
The notebooks in this section introduce the [Euclid](https://irsa.ipac.caltech.edu/Missions/euclid.html) data releases and products, and demonstrate access using various methods.
They are organized by data release.

(euclid-ero)=
## Early Release Observations (ERO)

This notebook describes the [Euclid ERO](https://irsa.ipac.caltech.edu/data/Euclid/docs/overview_ero.html) data products and demonstrates access.

- [Star Clusters](#euclid-ero-star-clusters) — Create multi-wavelength ERO image cutouts of a globular cluster, extract sources, and measure photometry.
...
These notebooks describe the [Euclid Q1](https://irsa.ipac.caltech.edu/data/Euclid/docs/overview_q1.html) data products and demonstrate access using various methods.
